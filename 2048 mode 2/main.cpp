...
int find_best_move(board_t board) {
	...
	//printf("Current scores: heur %.0f, actual %.0f\n", score_heur_board(board), score_board(board)); //output2
...
void play_game() {
    ...
    while(1) {
        ...
        rectprintf(290, 10, 100,100, "Current\nScore\n%.0f", score_board(board) - scorepenalty);//output 1
...
int main() {
    ...
    setcolor(BLACK);
    setfont(20, 0, "Tahoma");
    outtextrect(75, 625, 390, 45, "Press any key to make a worst move!");
